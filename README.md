...
Описание: Используется для указания элементов управления устройства, которые вовзращают неполный диапазон значений velocity (стандартный диапазон энкодеров/потенциометров [0, 127]).
